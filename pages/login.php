...
<div class="container py-5" style="height:auto;">
    <div class="row d-flex justify-content-center">
        <div class="col-md-12 ">
            <form class="form_container mx-auto" method="post">
                <div class="logo_container">
                    <img src="img/bookstudio.png" style="width:100%;height:auto;max-width:500px;max-height:500px;">
                </div>
                ...
                <div class="input_container">
                    ...
                    <input placeholder="name@mail.com" title="Inpit title" name="email" type="text" class="input_field" id="email_field" required autofocus>
                </div>
                <div class="input_container">
                    ...
                    <input placeholder="Password" title="Inpit title" name="password" type="password" class="input_field" id="password_field" required>
                </div>
                <button title="Sign In" type="submit" name="btnLogin" class="sign-in_btn">
                    <span>Sign In</span>
                </button>
